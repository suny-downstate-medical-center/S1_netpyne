...
if __name__ == '__main__':
    ...
    if dataType == 'spont':
        ...
        # filenames = ['/home/fernando/Documents/data_S1_Rat/v10_batch1/v10_batch1_0_0_data.pkl'] 
    ...
    for filename in filenames:
        ...
        sim.analysis.plotRaster(**{'include': cellParamS1, 'saveFig': filename[:-8]+'_raster_S1TH', 'orderBy':'y', 'showFig': False, 'popRates': 'minimal', 'orderInverse': True, 'timeRange': timeRange, 'figSize': (24,12), 'lw': 1.0, 'markerSize': 10, 'marker': '.', 'dpi': 300})
