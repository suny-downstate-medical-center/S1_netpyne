...
# sim.analysis.plotShape(includePost=cfg.cellParamLabels, showFig=True, includeAxon=False, showSyns=False, saveFig=True, figSize=(12,48))
...
sim.analysis.plot2Dnet(saveFig='../data/'+cfg.simLabel[0:9]+'/'+cfg.simLabel +'_xy.png', view='xy', figSize=(24,24), fontSize=17)
sim.analysis.plot2Dnet(saveFig='../data/'+cfg.simLabel[0:9]+'/'+cfg.simLabel +'_xz.png', view='xz', figSize=(24,24), fontSize=17)