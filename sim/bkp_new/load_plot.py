...
if __name__ == '__main__':
    ...
    if dataType == 'spont':
        filenames = ['../data/v10_batch1/v10_batch1_data.pkl']
        timeRange = [3000, 15000]
    ...
    for filename in filenames:
        ...
        sim.analysis.plotTraces(**{'include': S1cells, 'oneFigPer': 'trace', 'overlay': True, 'timeRange': timeRange, 'ylim': [-100,50], 'saveFig': True, 'showFig': False, 'figSize':(24,24)})
