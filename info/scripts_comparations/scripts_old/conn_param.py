...
ITinterFactor = cfg.ITinterFactor #1.0
...
L5BrecurrentFactor = cfg.L5BrecurrentFactor
...
WAStoK_factor = K_L5AtoL5A / WAS_L5AtoL5A * cfg.strengthFactor
...
# 9b. L2/3->L4 strength based on Yamawaki et al, 2015 is ~1/4 of L4->L2/3
# Approx matches: 0.041/0.117 = 0.35
# print smat[('W+AS_norm', 'IT', 'L2/3,4')][2,1] / smat[('W+AS_norm', 'IT', 'L2/3,4')][1,2]
